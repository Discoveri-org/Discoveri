...
Optimizer hyperparameters:
  ...
  - `length_scale_bound` (default value = `(1.0)`): bounds of `length_scale` during their optimization. See its definition in https://scikit-learn.org/stable/modules/generated/sklearn.gaussian_process.kernels.Matern.html
