...
Optimizer hyperparameters:
  - `number_of_tests` (default value: `100*number_of_dimensions`): the number of points evaluated with the surrogate model function to pick the most promising ones through the expected improvement acquisition function. 
